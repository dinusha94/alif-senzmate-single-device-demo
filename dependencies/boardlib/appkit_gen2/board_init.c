...
extern ARM_DRIVER_GPIO ARM_Driver_GPIO_(BOARD_BUTTON3_GPIO_PORT);
...
void BOARD_Pinmux_Init()
{
	...
	ARM_DRIVER_GPIO *BOARD_BUTTON3_GPIOdrv = &ARM_Driver_GPIO_(BOARD_BUTTON3_GPIO_PORT);
...
*/
	...
	BOARD_BUTTON3_GPIOdrv->Initialize(BOARD_BUTTON3_PIN_NO, NULL);
	BOARD_BUTTON3_GPIOdrv->PowerControl(BOARD_BUTTON3_PIN_NO, ARM_POWER_FULL);
	BOARD_BUTTON3_GPIOdrv->SetDirection(BOARD_BUTTON3_PIN_NO, GPIO_PIN_DIRECTION_INPUT);
	pinconf_set(PORT_(BOARD_BUTTON3_GPIO_PORT), BOARD_BUTTON3_PIN_NO, PINMUX_ALTERNATE_FUNCTION_0, config_button);
...
void BOARD_BUTTON3_GetState(BOARD_BUTTON_STATE *state)
{
	ARM_DRIVER_GPIO *BOARD_BUTTON3_GPIOdrv = &ARM_Driver_GPIO_(BOARD_BUTTON3_GPIO_PORT);
	uint32_t value;
	BOARD_BUTTON3_GPIOdrv->GetValue(BOARD_BUTTON3_PIN_NO, &value);
	*state = (BOARD_BUTTON_STATE)value;
}
